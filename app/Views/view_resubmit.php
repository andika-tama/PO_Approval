...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-9 p-5">
            <h2>Re-Submit Purchase List</h2>
            <hr>
            <form action="/inventory/resubmitted" method="POST" class="purchasing-list-sub">
                <div class="card">
                    <div class="card-header bg-login text-white text-center">
                        Ajukan Ulang Purchase List
                    </div>
                    <div class="card-body">
                        <div class="container-fluid">
                                ...
                                <div class="col-7">
                                    <div class="container">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-1">:</div>
                                            <div class="col-5"><input type="date" name="date_needed" required value="<?= $purchase['date_needed'] ?>"></div>
                                        </div>
                                ...
                                <div class="col-5">
                                    <div class="card">
                                        <div class="card-cost">
                                            ...
                                            <input type="hidden" name="total_cost" class="allCost" value="" data-total="<?= $purchase['total_cost'] ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <?php foreach ($submission as $s) : ?>
                                                    <tr>
                                                        ...
                                                        <td scope="row" class="text-center">
                                                            <input name="id[]" type="checkbox" value="<?= $s['id'] ?>" class="trigger" data-price="<?= $s['total_price'] ?>" <?= (in_array($s['id'], $dataSub)) ? "checked" : "" ?>>
                                                        </td>
                    ...
                    <div class="card-footer text-muted">
                        <input type="hidden" name="id_pl" id="" value="<?= $purchase['id'] ?>">
                        <div class="d-grid gap-2">
                            <button type="submit" name="submit" class="btn btn-dark bg-login border-login"> Ajukan Ulang Purchase List</button>
                        </div>
                    </div>
            </form>
        </div>
