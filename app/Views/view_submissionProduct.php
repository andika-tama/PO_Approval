                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            ...
                            <div class="row mt-3">
                                <div class="card">
                                    <div class="card-body">
                                        <table class="table table-striped table-hover" id="tb_product">
                                            <thead>
                                            ...
                                            <tbody>
                                                <?php foreach ($submission as $s) : ?>
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="text-start"><?= $s['name_product'] ?></td>
                                                        <td class="text-center"><?= $s['priority'] ?></td>
                                                        <td class="text-endr"><?= $s['price'] ?></td>
                                                        <td class="text-center"><?= $s['quantity'] ?></td>
                                                        <td class="text-end"><?= $s['total_price'] ?></td>
                    ...
                    <div class="card-footer text-muted">
                        <div class="d-grid gap-2">
                            <button type="submit" name="submit" class="btn btn-danger bg-login border-login"> Buat Purchase List</button>
                        </div>
                    </div>
            </form>
        </div>
